...
my $datafile = q{t/Test-dnssec05-F.data};
...
ok( $res{ALGORITHM_PRIVATE},        q{should emit ALGORITHM_PRIVATE} );
...
ok( !$res{ALGORITHM_NOT_RECOMMENDED}, q{should not emit ALGORITHM_NOT_ZONE_SIGN} );

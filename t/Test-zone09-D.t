...
my $datafile = q{t/Test-zone09-D.data};
...
my $zone = Zonemaster::Engine->zone( q{xd} );
...
ok( $res{Z09_NULL_MX_NON_ZERO_PREF},    q{should emit Z09_NULL_MX_NON_ZERO_PREF} );
ok( $res{Z09_NULL_MX_WITH_OTHER_MX},    q{should emit Z09_NULL_MX_WITH_OTHER_MX} );

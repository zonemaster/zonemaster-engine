...
my $datafile = q{t/Test-dnssec05-I.data};
...
ok( !$res{ALGORITHM_DELETE_DS},       q{should no longer emit ALGORITHM_DELETE_DS} );
ok( !$res{ALGORITHM_INDIRECT_KEY},    q{should no longer emit ALGORITHM_INDIRECT_KEY} );

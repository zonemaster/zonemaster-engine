...
scenario 'INCONSISTENT-MX-DATA-4' => sub {
    expect 'Z09_INCONSISTENT_MX_DATA';
    expect Z09_MX_DATA => {
        ns_list => 'ns1.inconsistent-mx-data-4.zone09.xa/127.19.9.31;'
                 . 'ns1.inconsistent-mx-data-4.zone09.xa/fda1:b2:c3:0:127:19:9:31',
        mxrdata_list => '10 mail.inconsistent-mx-data-4.zone09.xa;'
                      . '20 mail.inconsistent-mx-data-4.zone09.xa'
    };
    expect Z09_MX_DATA => {
        ns_list => 'ns2.inconsistent-mx-data-4.zone09.xa/127.19.9.32;'
                 . 'ns2.inconsistent-mx-data-4.zone09.xa/fda1:b2:c3:0:127:19:9:32',
        mxrdata_list => '10 mail.inconsistent-mx-data-4.zone09.xa'
    };
    forbid_others;
};

scenario 'MIXED-CASE-RDATA-1' => sub {
    expect Z09_MX_DATA => {
        ns_list => 'ns1.mixed-case-rdata-1.zone09.xa/127.19.9.31;'
                 . 'ns1.mixed-case-rdata-1.zone09.xa/fda1:b2:c3:0:127:19:9:31;'
                 . 'ns2.mixed-case-rdata-1.zone09.xa/127.19.9.32;'
                 . 'ns2.mixed-case-rdata-1.zone09.xa/fda1:b2:c3:0:127:19:9:32',
        mxrdata_list => '10 mail.mixed-case-rdata-1.zone09.xa;'
                      . '20 mail2.mixed-case-rdata-1.zone09.xa'
    };
    forbid_others;
};

scenario 'MIXED-CASE-RDATA-2' => sub {
    # This scenario relies on saved packets faithfully reproducing the incoming
    # packet in wire format, which is currently not quite the case.
    not_testable 'see https://github.com/zonemaster/zonemaster-engine/issues/1554';

...
my $datafile = q{t/Test-consistency05-G.data};
...
Zonemaster::Engine->add_fake_delegation(
    'g.consistency05.exempelvis.se' => {
        'ns1.g.consistency05.exempelvis.se' => [ '46.21.97.98',   '2a02:750:12:77::97' ],
        'ns2.g.consistency05.exempelvis.se' => [ '37.123.169.92', '2001:9b0:1:1c13::53' ],
    }
);

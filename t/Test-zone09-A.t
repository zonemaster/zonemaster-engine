...
my $datafile = q{t/Test-zone09-A.data};
...
my $zone = Zonemaster::Engine->zone( q{xa} );

my %res = map { $_->tag => $_ } Zonemaster::Engine::Test::Zone->zone09( $zone );

ok( $res{Z09_INCONSISTENT_MX},          q{should emit Z09_INCONSISTENT_MX} );
...
ok( $res{Z09_TLD_EMAIL_DOMAIN},         q{should emit Z09_TLD_EMAIL_DOMAIN} );

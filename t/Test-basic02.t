...
# The names of the environment variables should maybe be changed to "ZONEMASTER_SINGLE_SCENARIOS" and "ZONEMASTER_DISABLE_SCENARIOS"
# to better match how they work in "TestUtil.pm".

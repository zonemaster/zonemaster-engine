...
my $datafile = q{t/Test-consistency05-E.data};
...
Zonemaster::Engine->add_fake_delegation(
    'e.consistency05.exempelvis.se' => {
        ...
        'ns2.e.consistency05.exempelvis.se' => [ '37.123.169.91', '2001:9b0:1:1c13::53' ],
    }
);
...
ok( $res{CHILD_NS_FAILED},                 q{should emit CHILD_NS_FAILED} );

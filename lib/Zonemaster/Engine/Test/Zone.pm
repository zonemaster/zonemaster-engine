...
sub zone02 {
    ...
    my $soa_refresh_minimum_value = $SOA_REFRESH_MINIMUM_VALUE;
...
sub zone04 {
    ...
    my $soa_retry_minimum_value = $SOA_RETRY_MINIMUM_VALUE;
...
sub zone05 {
    ...
    my $soa_expire_minimum_value = $SOA_EXPIRE_MINIMUM_VALUE;
...
sub zone06 {
    ...
    my $soa_default_ttl_maximum_value = $SOA_DEFAULT_TTL_MAXIMUM_VALUE;
    my $soa_default_ttl_minimum_value = $SOA_DEFAULT_TTL_MINIMUM_VALUE;
